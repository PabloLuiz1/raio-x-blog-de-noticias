        ...
        <div class="container-fluid">
            ...
            <div class="col-md-3 float-left mt-2 p-0">
                <form action="php/criarSessao.php" class="form-login" method="POST">
                    ...
                    <div class="font-weight-bold ml-4">Informe seu login para identificarmos a sua conta. E então iremos enviar um link para redefinição da senha no e-mail cadastrado. </div>
                    ...
                    <div class="form-group" style="padding-left: 17%; padding-right: 17%;">
                        <div class="col-sm-12">
                            <input type="submit" class="btn btn-success pull-right font-weight-bold" name="logar" value=" Enviar ">
