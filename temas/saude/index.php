...
<?php 
    ...
    $noticias = selectNoticiaSeis("tbnoticia.ativo = 1 AND tema = 'Saúde'");
    $numeromeses = array (
        1 => selectQtdPorMes('2019', '1', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '2', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '3', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '4', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '5', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '6', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '7', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '8', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '9', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '10', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '11', "tema = 'Saúde'")['total'],
        selectQtdPorMes('2019', '12', "tema = 'Saúde'")['total']
    );
?>
<html lang="pt-br">
    <head>
