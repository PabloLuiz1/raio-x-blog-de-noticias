...
<?php 
    ...
    $noticias = selectNoticiaSeis("tbnoticia.ativo = 1 AND estado = 'Saúde'");
    $numeromeses = array (
        1 => selectQtdPorMes('2019', '1', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '2', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '3', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '4', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '5', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '6', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '7', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '8', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '9', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '10', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '11', "estado = 'Saúde'")['total'],
        selectQtdPorMes('2019', '12', "estado = 'Saúde'")['total']
    );
?>
<html lang="pt-br">
    <head>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-sm bg-gray navbar-light justify-content-center">
                <ul class="navbar-nav" style="margin-right: 49%;">
                    ...
                    <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item active" href="#">Saúde</a>
                ...
                <div class="col-md-8 float-left mt-2 ml-4 mr-3">
                    <h2 class="col-md-12 border-bottom border-secondary">Saúde</h2>
                            ...
                            <div id="collapseOne" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <?php 
                                            ...
                                            for ($i = 1; $i < 13; $i++){
                                                echo ('<a href="../../news.php?m='.$i.'&a=2019&t=Saúde" class="li-hover list-group-item d-flex justify-content-between align-items-center">
                                                    '.$nomemeses[$i].'
