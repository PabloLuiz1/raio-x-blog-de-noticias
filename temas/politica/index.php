        ...
        <header>
            ...
            <nav class="navbar navbar-expand-sm bg-gray navbar-light justify-content-center">
                <ul class="navbar-nav" style="margin-right: 49%;">
                    ...
                    <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item active" href="#">Política</a>
                ...
                <div class="col-md-8 float-left mt-2 ml-4 mr-3">
                    <h2 class="col-md-12 border-bottom border-secondary">Política</h2>
                            ...
                            <div id="collapseOne" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <?php 
                                            ...
                                            for ($i = 1; $i < 13; $i++){
                                                echo ('<a href="../../news.php?m='.$i.'&a=2019&t=Política" class="li-hover list-group-item d-flex justify-content-between align-items-center">
                                                    '.$nomemeses[$i].'
