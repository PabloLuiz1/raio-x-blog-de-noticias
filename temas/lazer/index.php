...
<?php 
    ...
    $noticias = selectNoticiaSeis("tbnoticia.ativo = 1 AND estado = 'Lazer'");
    
    $numeromeses = array (
        1 => selectQtdPorMes('2019', '1', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '2', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '3', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '4', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '5', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '6', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '7', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '8', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '9', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '10', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '11', "estado = 'Lazer'")['total'],
        selectQtdPorMes('2019', '12', "estado = 'Lazer'")['total']
    );
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-sm bg-gray navbar-light justify-content-center">
                ...
                <div class="col-md-8 float-left mt-2 ml-4 mr-3">
                    <h2 class="col-md-12 border-bottom border-secondary">Lazer</h2>
                            ...
                            <div id="collapseOne" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <?php 
                                            ...
                                            for ($i = 1; $i < 13; $i++){
                                                echo ('<a href="../../news.php?m='.$i.'&a=2019&t=Lazer" class="li-hover list-group-item d-flex justify-content-between align-items-center">
                                                    '.$nomemeses[$i].'
