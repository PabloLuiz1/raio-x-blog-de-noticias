    ...
    <div class="container-fluid p-0">
        <header>
            ...
            <div class="col-md-11 float-left mt-2 ml-5">
                <h3>Minhas postagens <i class="fa fa-newspaper fa-md"></i></h3>
                ...
                <form class="form-inline pull-right mt-1 mb-3 p-0 col-sm-4" action="/action_page.php">
                        <input class="form-control form-control-sm mr-sm-2 col-sm-6 ml-5" style="width: %;"type="text" placeholder="Pesquisar suas postagens" required>
                ...
                <table class="table-bordered table-hover table text-center">
                    ...
                    <tbody>
                        <tr>
                            <td><a href="#"> A mentira sobre a rota bla lbllala blpel sla  asldasldalsdalsdasl alsdlasdasl </a></td>
                            <td>Esporte</td>
                            <td>10/01/2019 às 5:58</td>
                            <td><a href="#">kaskdaskdaskdask.pdf</a></td>
                            <td><a href="#"><i class="fa fa-edit fa-lg"></i></a></td>
                            <td><a href="#"><i class="fa fa-trash-alt fa-lg"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
