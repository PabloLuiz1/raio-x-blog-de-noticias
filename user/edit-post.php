...
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <title>BlogDeNoticias | Editar post</title>
                ...
                <form class="form-postar col-md-6" action="edit-post.php?p=<?php echo $_GET['p'];?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <select name="tema" id="tema" class="form-control" required>
                            ...
                            <option value="Arquivos do X" <?php if ($tema == "Arquivos do X") echo "selected" ?>>Arquivos do X</option>
                            <option value="Lazer" <?php if ($tema == "Lazer") echo "selected" ?>>Lazer</option>
                            <option value="Política" <?php if ($tema == "Política") echo "selected" ?>>Política</option>
                            <option value="Saúde" <?php if ($tema == "Saúde") echo "selected" ?>>Saúde</option>
