            ...
            <div class="col-md-11 float-left mt-2 ml-5">
                ...
                <form class="form-postar col-md-6" action="#" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Insira o título da postagem" required disabled>
                        <label for="resumo">Resumo: </label>
                        <textarea rows="3" class="form-control" id="resumo" name="resumo" placeholder="Insira um breve resumo sobre a postagem" required disabled></textarea>
                        ...
                        <input type="file" class="form-control-file" id="imagem" name="imagem" required disabled>
                        <label for="arquivo">Arquivo em .PDF: </label>
                        <input type="file" class="form-control-file" id="arquivo" name="arquivo" required disabled>
                        <label for="autor">Autor: </label>
                        <input type="text" class="form-control mb-3" name="autor" id="autor" placeholder="Nome do autor" required disabled>
                        <label for="linkyoutube">Link do vídeo: </label>
                        <input type="text" class="form-control mb-3" id="linkyoutube" name="linkyoutube" placeholder="Insira o link do vídeo no YouTube sobre a postagem" required disabled>
                        <input type="submit" class="btn btn-danger pull-right font-weight-bold mb-5" value="Excluir">
