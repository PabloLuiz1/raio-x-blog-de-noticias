...
<?php 
    ...
    $noticias = selectNoticiaSeis('tbnoticia.ativo = 1');
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-footer">Newsletter - Saiba de cada postagem nova no blog:
                    <form class="form-inline newsletter" method="POST" action="php/assinar-email.php">
                        <input class="form-control form-control-sm col-sm-6 mr-sm-4" name="email" id="email" type="email" placeholder="Insira seu e-mail" required>
                        <input type="submit" class="btn btn-sm btn-success font-weight-bold" type="submit" value="Assinar">
                    </form>
                </div>
            </div>
            <div class="row">
