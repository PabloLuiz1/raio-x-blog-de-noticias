...
<body>
    <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-sm bg-gray navbar-light justify-content-center">
                <ul class="navbar-nav" style="margin-right: 49%;">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown-menu">
                            Noticias
                        </a>
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="help.php">Sobre</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="help.php">Contato</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="help.php">Logar</a>
                    </li>
                </ul>
        ...
        <footer>
            ...
            <div class="row">
                <div class="col-sm-4 col-footer"></div>
                <div class="col-sm-4 col-footer"><span class="copyright">BlogDeNoticias todos os direitos reservados, 2019.
