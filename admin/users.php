...
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <title>BlogDeNoticias | Usuários</title>
    ...
    <div class="container-fluid p-0">
        <header>
            ...
            <div class="col-md-11 float-left mt-2 ml-5">
                ...
                <a href="#" class="text-decoration-none"><button class="btn btn-sm btn-success mt-1 font-weight-bold">Novo usuário <i class="fa fa-plus fa-sm"></i></button></a>
                ...
                <table class="table-bordered table-hover table text-center">
                    ...
                    <tbody>
                        <tr>
                            <td>Fulano Cicrano da Silva de Oliveira</td>
                            <td>fulano.cicrano@gmail.com</td>
                            <td>fulanoci</td>
                            <td>11 912345678</td>
                            <td><a href="#">9</a></td>
